...
# Start time (10 years ago)
years_back = 10
start_time = datetime.now() - timedelta(days=years_back * 365)
start_timestamp = int(start_time.timestamp() * 1000)

# Fetch the data
print("Fetching 10 years of hourly BTC/USDT data...")
historical_data = fetch_historical_ohlcv(since=start_timestamp)
...
# Save to CSV
df.to_csv("btc_hourly_10years.csv", index=False)

print(f"✅ Data collection complete! Saved {len(df)} rows to 'btc_hourly_10years.csv'.")
