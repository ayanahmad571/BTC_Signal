...
# Load data
df = pd.read_csv("btc_hourly_10years.csv")
...
# Save processed data
df.to_csv("btc_hourly_features.csv", index=False)

print(f"✅ Feature engineering complete! Data saved to 'btc_hourly_features.csv' with {df.shape[1]} columns.")
